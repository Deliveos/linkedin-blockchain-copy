            ...
            <div class=" flex-col flex-1 md:basis-8/12 space-y-2  ">
                    ...
                    <div class="flex relative justify-between  pt-14  pb-7 pl-6 pr-5 md:pr-20 items-start">
                        ...
                        <div class="">
                            ...
                            <div class="flex  justify-start items-center text-sm">
                                ...
                                <div class="mx-1">•</div>
                                <a href="#" class="text-primary hover:underline font-semibold">contact information</a>
                        </div>
                        <a href="#" class="text-primary text-sm hover:underline font-semibold">500+ links</a>
                ...
                <div class="border flex flex-col space-y-2 bg-white rounded-lg">
                    <div class=" relative py-6 pl-6 pr-14">
                        ...
                        <p class="font-semibold text-xl mb-3">About</p>
                ...
                <div class="border flex flex-col space-y-2 bg-white rounded-lg">
                    <div class="relative py-6 pl-6 space-y-4 ">
                        ...
                        <p class="font-semibold text-xl mb-3">Experience</p>
                    ...
                    Technical Support · Computer Hardware · Computer Hardware Troubleshooting · Computer
                Repair · Computer Networks · Human Computer Interaction
                </div> -->
                            </div>
                        </div>
