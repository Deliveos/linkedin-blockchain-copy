...
<template>
    ...
    <div class="bg-[#f3f2ef] rounded-md w-screen h-screen">
        <div class="container pt-12 px-4 md:py-5">
            ...
            <h3 class="mb-10 hidden md:block font-medium text-black text-xl md:text-4xl text-center">Professional
            ...
            <div v-if="showCard" class="flex-1 md:w-1/2 lg:w-2/5 mx-auto rounded-md bg-white py-6 px-6 space-y-4">
                ...
                <div class="flex flex-col">
                    <label for="email" class="text-muted text-sm">E-mail</label>
                ...
                <div class="flex flex-col">
                    <label for="password" class="text-muted text-sm">Password (6 or more characters)</label>
                ...
                <div class="text-center">
                    <small class="text-center text-muted font-semibold align-middle leading-2">
                        By clicking Accept and Join, LinkedIn <a href="#"
                            class="text-primary hover:underline">User
                            <br>
                            agreement</a>, <a href="#" class="text-primary hover:underline"> Privacy Policy</a>
                        and<a href="#" class="text-primary hover:underline"> cookie
                            policy</a> You accept it.
                    </small>
                </div>
                ...
                <p class="text-center">Already a member of LinkedIn? <router-link to="/signup"
                        class="text-primary hover:cursor-pointer hover:underline font-bold">Sign in</router-link></p>
            </div>
        </div>
    </div>
</template>