    ...
    <div class="bg-white rounded-md w-screen h-screen">
        <div class="container px-3 pt-12 md:py-5">
            ...
            <div class="flex-1  md:w-1/2 lg:w-1/3 mx-auto rounded-md mt-36 drop-shadow-xl bg-white py-6 px-6 ">
                <div>
                    <h3 class="text-2xl font-semibold">Choose a new password.</h3>
                    <small>Create a new password that is at least 6 characters long.</small>
                </div>
                ...
                <div class="relative my-4">
                    ...
                    <small class="text-red-600" v-if="!validPasswords">Password does not match</small>
                </div>
