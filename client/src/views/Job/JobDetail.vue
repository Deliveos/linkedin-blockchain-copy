        ...
        .then((res) => {
            if (res.status === 200) {
                ...
                store.dispatch("notifications/showMessage", {
                    message: "Application for the job posting was successful",
                    type: "success",
                });
            }
        }).catch((err) => {
        ...
        <div class="flex flex-col md:flex-row  justify-between pb-52 items-center md:items-start md:space-x-5 ">
            <div class="w-full mt-4 md:mt-0 md:basis-3/4 px-4 flex flex-col space-y-2">
                <div class="border bg-white p-6 rounded-lg">
                    ...
                    <div class="flex flex-col mt-2">
                        ...
                        <div class="flex flex-wrap text-sm justify-start items-center space-x-2 md:mt-2">
                            ...
                            <p class="text-muted">{{ job.applicants?.length }} applicant</p>
                        </div>
                        <ul class="text-sm my-6 space-y-3">
                            ...
                            <li class="flex justify-start items-center space-x-2">
                                ...
                                <p>{{ job?.company?.employees?.length }} worker · {{ job?.company?.category }}</p>
                            </li>
                            <li class="flex justify-start items-center space-x-2">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" data-supported-dps="24x24"
                                    fill="currentColor" class="fill-muted" width="24" height="24" focusable="false">
                                ...
                                <p>5 connections · 18 former company employees · 26 school graduates</p>
                            </li>
                            <li class="flex justify-start items-center space-x-2">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" data-supported-dps="24x24"
                                    fill="currentColor" class="fill-muted" width="24" height="24" focusable="false">
                                ...
                                <p>{{ job.applicants?.length }} See how you compare to the applicant.
                                <p class="cursor-pointer underline">Try Premium for free</p>
                                </p>
                            </li>
                            <li class="flex justify-start items-center space-x-2">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" data-supported-dps="24x24"
                                ...
                                <p>Skills: English, Software Development, +8 more</p>
                            </li>
                        </ul>
                        <div v-if="!hasAlreadyApplied" class="flex justfiy-start items-center space-x-2">
                            <button @click="applyJob"
                                ...
                                <i class="fa-brands fa-linkedin"></i>Easy reference
                            </button>
                            <button
                        ...
                        <div v-else>
                            <h2 class="text-xl mb-2 font-semibold">Easy reference</h2>
                ...
                <div class="border bg-white p-4 rounded-lg">
                    <p class="text-xl font-semibold mb-4">Meet the recruiting team</p>
                        ...
                        <div
                            ...
                            <div class="flex flex-col">
                                ...
                                <small class="text-muted mb-2">
                                    Job posting · LinkedIn member since 2017
                                </small>
                                <small class="text-muted mb-2">
                                    15 affiliate links</small>
                            </div>
                            <button
                ...
                <div class="border bg-white p-4 rounded-lg">
                    <p class="text-xl font-semibold mb-4">About the job posting</p>
            ...
            <div class="sticky -top-[200px] basis-1/4 hidden lg:flex flex-col">
                <div class="border space-y-2 bg-white rounded-lg">
                    <p class="font-semibold px-4 py-6 ">Safety tips for your job search</p>
                    <div
                ...
                <div class="px-8">
                    <ul class="text-xs text-muted space-y-2">
                        <div class="flex justify-between items-center">
                            ...
                            <li class="hover:text-primary hover:underline"><a href="#"> accessibilitн</a></li>
