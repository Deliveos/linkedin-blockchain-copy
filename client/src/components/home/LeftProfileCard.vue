        ...
        <div class="hidden md:block">
            <div class="py-2 border-b">
                <div
                    ...
                    <small class=" text-muted ">The person viewed your profile</small>
                    <small class=" text-primary">41</small>
                </div>
                <div
                    class="flex justify-between font-semibold items-center px-3 py-1 hover:bg-gray-300 hover:cursor-pointer transition-all duration-150">
                    <small class=" text-muted ">Impressions for your post</small>
            ...
            <div class=" border-b">
                <div
                    ...
                    <small class="text-xs text-muted font-light">Access exclusive tools and insights</small>
                    <div class="flex justify-start items-start space-x-2">
                        ...
                        <span class="text-xs group-hover:text-primary underline mb-1">Hire faster. Free
                            try
                            Premium.</span>
                    </div>
                </div>
