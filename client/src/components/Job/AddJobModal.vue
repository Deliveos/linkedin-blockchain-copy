            ...
            <div class="flex  items-end justify-center p-2  sm:items-center sm:p-0">
                <div
                    ...
                    <div class=" md:px-6 p-3 md:py-3  flex justify-between items-center">
                        <h3 class=" md:text-2xl font-semibold" id="modal-title">Make great hires quickly</h3>
                    ...
                    <div class="overflow-auto md:pt-2 pb-4 px-2 sm:py-3 ">
                        <div class="mt-3 pr-3 sm:mt-0 sm:ml-4 flex flex-col space-y-4  ">
                            <div class=" flex justify-start text-sm  items-center">
                                Recruitment quality ranks #1 on the rise.
                            </div>
                            <div class="flex flex-col  space-y-2">

                                <div class="md:space-y-4 space-y-2">
                                    <div class="flex flex-col">
                                        <label for="title" class="text-muted text-xs sm:text-sm">Job title</label>
                                    ...
                                    <div class="flex flex-col">
                                        <label for="work_type" class="text-muted text-xs sm:text-sm">How it works</label>
                                        <div class="flex justify-between items-center">
                                            <select v-model="userData.work_type" name="work_type" id="work_type"
                                                ...
                                                <option value="office" selected>In the office</option>
                                    ...
                                    <div class="flex flex-col">
                                        <label for="company_name" class="text-muted text-xs sm:text-sm">Company</label>
                                        <div class="flex justify-between items-center">
