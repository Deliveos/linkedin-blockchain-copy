                ...
                <div class="flex relative md:static justify-between items-center">
                    ...
                    <ul class="flex justify-between items-center ">
                        <div
                            ...
                            <li class="text-muted">
                                <router-link tag="li"
                                    ...
                                    </svg><small class="whitespace-nowrap">Job Postings</small>
                        ...
                        <li
                            ...
                            </svg><small class="text-muted hidden md:block group-hover:text-black">Messaging</small>
                        </li>
                        <router-link to="/notifications"
                        ...
                        <li @click="showSettingsCard = !showSettingsCard"
                            ...
                            <div class="md:flex hidden justify-between items-center space-x-1">
                                <small class="text-muted  group-hover:text-black">I</small><i
                        ...
                        <li
                            ...
                            <div class="flex  justify-between items-center space-x-1">
                                <small class="text-muted hidden lg:block group-hover:text-black">Work</small><i
                                    class="fas fa-caret-down text-muted group-hover:text-black"></i>
                            </div>
                        </li>
                        <li class="text-center  hover:cursor-pointer group w-32 leading-[1px] break-words ">
                            <a href="#"
                                ...
                                Hire faster. Try it for free Premium.
                            </a>
                        </li>
