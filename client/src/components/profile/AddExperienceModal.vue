            ...
            <div class="flex  items-end justify-center p-2  sm:items-center sm:p-0">
                <div
                    ...
                    <div class="border-b md:px-6 p-3 md:py-3 border border-opacity-70 flex justify-between items-center">
                        <h3 class=" md:text-xl " id="modal-title">Experience</h3>
                        ...
                        <div class="mt-3 pr-3 sm:mt-0 sm:ml-4 flex flex-col space-y-4  ">
                            ...
                            <div class="flex flex-col  space-y-2">
                                <div class="flex justify-between items-center">
                                    <p class="sm:text-xl ">experiences</p>
                                    <!-- <button
                                ...
                                <div class="md:space-y-4 space-y-2">
                                    <div class="flex flex-col">
                                        <label for="title" class="text-muted text-xs sm:text-sm">Title*</label>
                                    ...
                                    <div class="flex flex-col">
                                        <label for="company_name" class="text-muted text-xs sm:text-sm">Company name*</label>
                                        <div class="flex justify-between items-center">
                                    ...
                                    <div class="flex flex-col">
                                        <label for="company_location" class="text-muted text-xs sm:text-sm">Location*</label>
                                        <input v-model="userData.location" placeholder="Örn: İstanbul, Türkiye" type="text"
                                            name="" id="company_location"
                                            class="mt-1 px-2 py-1 border border-1 placeholder:text-sm  border-muted hover:ring-black hover:ring-1 transition-all duration-300 focus:outline-primary active:ring-0 rounded-md" />
                                    </div>
                                    <div class="flex flex-col">
                                        <label for="company_location" class="text-muted text-xs sm:text-sm">Beginning -
                                            Finish
                                            Date*</label>
                    ...
                    <div
                        ...
                        <button @click="addExperience"
                            class="bg-primary  rounded-full py-1 px-3 text-white active:bg-[#09223b] hover:bg-[#004182] transition-all duration-300 font-bold">Save</button>
                    </div>
